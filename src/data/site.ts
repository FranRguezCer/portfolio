...
export const WORK: WorkCase[] = [
  ...
  },
  {
    ...
    oneLiner: { en: 'PySpark ETL contributions within an existing on-premises platform organised around medallion layers and separated compute and storage.', es: 'Contribuciones a pipelines ETL con PySpark dentro de una plataforma on-premises existente, organizada en capas medallion y con cómputo y almacenamiento separados.' },
    sections: {
      en: [
        ...
        { key: 'work', title: 'What I did', paragraphs: ['Contributed to PySpark ETL pipelines within the existing corporate on-premises data lake, filling gaps spanning several months and producing clean, normalized and aggregated datasets. Working on those pipelines required understanding how the platform’s medallion layers and separate compute and storage were organised.'] },
        { key: 'approach', title: 'Architecture / Technical approach', paragraphs: ['Worked within an existing bronze, silver and gold medallion architecture over Apache Ozone, with Apache Iceberg tables, Kafka and Debezium for supported change-data-capture flows, Trino for querying, and OpenMetadata for governance and discovery. Most supported source onboarding followed reusable pipeline patterns and configuration, with engineering work retained for exceptional integrations.', '“Deltalake” was the platform’s internal name; it did not refer to Databricks Delta Lake.'] },
        { key: 'impact', title: 'Impact', paragraphs: ['My pipeline contributions recovered several months of missing data and helped reduce the time needed to derive insights by about 40%.'] },
        { key: 'decisions', title: 'Design decisions', paragraphs: ['The existing platform separated compute, storage and metadata so it could evolve on-premises without coupling the data model to a single processing engine.', 'For my contributions, I followed its repeatable ingestion patterns and treated unusual sources as explicit engineering work rather than assuming every source was configuration-only.'] },
      ],
      es: [
        ...
        { key: 'work', title: 'Qué hice', paragraphs: ['Contribuí a pipelines ETL con PySpark dentro del data lake corporativo on-premises existente, completando lagunas de varios meses y generando datasets limpios, normalizados y agregados. Trabajar en esos pipelines exigió entender cómo estaban organizadas las capas medallion de la plataforma y la separación entre cómputo y almacenamiento.'] },
        { key: 'approach', title: 'Arquitectura / Enfoque técnico', paragraphs: ['Trabajé dentro de una arquitectura medallion existente con capas bronze, silver y gold sobre Apache Ozone, tablas Apache Iceberg, Kafka y Debezium para flujos compatibles de captura de cambios, Trino para consulta y OpenMetadata para gobierno y descubrimiento. La mayoría de las fuentes compatibles se incorporaban mediante patrones reutilizables y configuración, reservando trabajo de ingeniería para integraciones excepcionales.', '“Deltalake” era el nombre interno de la plataforma; no hacía referencia a Databricks Delta Lake.'] },
        { key: 'impact', title: 'Impacto', paragraphs: ['Mis contribuciones a los pipelines permitieron recuperar varios meses de datos ausentes y ayudaron a reducir aproximadamente un 40% el tiempo necesario para obtener insights.'] },
        { key: 'decisions', title: 'Decisiones de diseño', paragraphs: ['La plataforma existente separaba el cómputo, el almacenamiento y los metadatos para poder evolucionar on-premises sin ligar el modelo de datos a un único motor de procesamiento.', 'En mis contribuciones seguí sus patrones repetibles de ingesta y traté las fuentes inusuales como trabajo explícito de ingeniería, sin asumir que cualquier fuente se añadía solo mediante configuración.'] },
      ],
    },
