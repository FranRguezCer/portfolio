...
export const STR: Str = {
  en: {
    ...
    overview: 'Overview',
    stack: 'Stack',
    stackDisclosure: 'View full stack',
    notesLbl: 'Notes',
    yearLbl: 'Year',
    typeLbl: 'Domain',
  ...
  es: {
    ...
    overview: 'Resumen',
    stack: 'Stack',
    stackDisclosure: 'Ver stack completo',
    notesLbl: 'Notas',
    yearLbl: 'Año',
    typeLbl: 'Dominio',
...
export const EXPERIENCE: ExperienceEntry[] = [
  {
    ...
    bullets: {
      ...
      es: [
        'Construí un asistente agéntico para evaluación y redacción asistida de pliegos técnicos, basado en RAG sobre embeddings almacenados en una base de datos vectorial ChromaDB. Reduce ~50% la carga manual del equipo y entrega trazabilidad completa. Sistema 100% on-premise, sin dependencia de APIs externas ni exposición de datos sensibles.',
        'Evolucioné el Deltalake corporativo con grandes volúmenes de datos en tiempo real, consolidando una fuente única de verdad analítica que sirve a múltiples dominios y casos de uso dentro de la organización.',
