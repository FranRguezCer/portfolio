...
export const EXPERIENCE: ExperienceEntry[] = [
  {
    ...
    bullets: {
      ...
      es: [
        ...
        'Contribuí al Deltalake corporativo con grandes volúmenes de datos en tiempo real, consolidando una fuente única de verdad analítica que sirve a múltiples dominios y casos de uso dentro de la organización. El impacto: democratizar el acceso a esos datos y facilitar el cruce de información de distintas fuentes bajo demanda.',
